...
export async function generateAndPrintReceipt(payment: CivicPayment | ReceiptPrintData) {
  ...
  const verificationHash = await sha256(`SAMAGRA_TREASURY_CHALLAN_${receiptNumber}_${amount}_${paidDate}`)
...
<body>
  <div class="container">
    <div class="watermark">SAMAGRA VERIFIED</div>

    <div class="header">
      <div>
        <h1 class="emblem-title">GOVERNMENT OF KARNATAKA</h1>
        <p class="sub-title">DEPARTMENT OF TREASURY & MUNICIPAL REVENUE • SAMAGRA SOVEREIGN CLEARING</p>
      </div>
    ...
    <div class="footer">
      <div class="seal-text">
        This document is an electronically issued, digitally authenticated statutory receipt under Section 65B of the Indian Evidence Act. Generated by SAMAGRA Citizen Operating System. No physical signature is required.
      </div>
      <div style="text-align: right;">
        <span style="display: block; font-size: 18px; font-weight: 800; color: #0369a1; letter-spacing: -1px;">SAMAGRA</span>
